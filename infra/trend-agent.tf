module "trend_agent" {
  ...
  # Agent deployment
  agent_source_path               = "./agents/trend_agent"
...
resource "google_project_iam_member" "trend_agent_access" {
  ...
  member = "serviceAccount:${module.trend_agent.service_account_email}"
}

resource "google_project_iam_member" "trend_agent_bq_job_user" {
