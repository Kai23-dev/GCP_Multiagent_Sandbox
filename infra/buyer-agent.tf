module "buyer_agent" {
  ...
  additional_env_vars = {
    ...
    VISUALIZATION_AGENT_RESOURCE                       = module.visualization_agent.reasoning_engine_name
  }
  ...
  # Agent deployment
  agent_source_path = "./agents/buyer_agent"
...
resource "google_project_iam_member" "buyer_agent_access" {
  ...
  member = "serviceAccount:${module.buyer_agent.service_account_email}"
}

resource "google_project_iam_member" "buyer_agent_bq_job_user" {
