module "financial_leakage_agent" {
  ...
  agent_id   = "financial-leakage-agent"
  ...
  # Agent deployment
  agent_source_path               = "./agents/financial_leakage_agent"
...
resource "google_project_iam_member" "financial_leakage_agent_access" {
  ...
  member = "serviceAccount:${module.financial_leakage_agent.service_account_email}"
}

resource "google_project_iam_member" "financial_leakage_agent_bq_job_user" {
